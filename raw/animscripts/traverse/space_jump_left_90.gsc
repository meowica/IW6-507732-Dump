...
main()
{
	...
	{
		AssertMsg( "Traversal space_traversal_jump_90_R being used by a non-space character." );
		return;
	}
	...
	// TRAVERSE METHOD
	//traverseData = [];
	//traverseData[ "traverseAnim" ]			 = %space_traversal_jump_90_R;
	...
	self setFlaggedAnimKnoballRestart( "3dtraverseAnim", %space_traversal_jump_90_R, %root, 1, .1, 1 );
	//wait 5.15;
