...
init_riotshield_AI_anims()
{
	...
	initAnimSet = [];
	initAnimSet["cover_trans"][ "riotshield" ][ 1 ] = %riotshield_run_approach_1;
	initAnimSet["cover_trans"][ "riotshield" ][ 2 ] = %riotshield_run_approach_2;
	initAnimSet["cover_trans"][ "riotshield" ][ 3 ] = %riotshield_run_approach_3;
	initAnimSet["cover_trans"][ "riotshield" ][ 4 ] = %riotshield_run_approach_4;
	initAnimSet["cover_trans"][ "riotshield" ][ 6 ] = %riotshield_run_approach_6;
	initAnimSet["cover_trans"][ "riotshield" ][ 7 ] = undefined;
	initAnimSet["cover_trans"][ "riotshield" ][ 8 ] = %riotshield_walk2crouch_8;
	initAnimSet["cover_trans"][ "riotshield" ][ 9 ] = undefined;

	initAnimSet["cover_trans"][ "riotshield_crouch" ][ 1 ] = %riotshield_walk_approach_1;
	initAnimSet["cover_trans"][ "riotshield_crouch" ][ 2 ] = %riotshield_walk_approach_2;
	initAnimSet["cover_trans"][ "riotshield_crouch" ][ 3 ] = %riotshield_walk_approach_3;
	initAnimSet["cover_trans"][ "riotshield_crouch" ][ 4 ] = %riotshield_walk_approach_4;
	initAnimSet["cover_trans"][ "riotshield_crouch" ][ 6 ] = %riotshield_walk_approach_6;
	initAnimSet["cover_trans"][ "riotshield_crouch" ][ 7 ] = undefined;
	initAnimSet["cover_trans"][ "riotshield_crouch" ][ 8 ] = %riotshield_walk2crouch_8;
	initAnimSet["cover_trans"][ "riotshield_crouch" ][ 9 ] = undefined;
	...
	for ( j = 0; j < riotshieldTransTypes.size; j++ )
	{
		...
		for ( i = 1; i <= 9; i++ )
		{
			...
			if ( isdefined( initAnimSet["cover_trans"][ trans ][ i ] ) )
			{
				initAnimSet["cover_trans_dist"][ trans ][ i ] = getMoveDelta( initAnimSet["cover_trans"][ trans ][ i ], 0, 1 );
			}
		}
	}

	initAnimSet["cover_trans_angles"][ "riotshield_crouch" ][ 1 ] = 45;
	initAnimSet["cover_trans_angles"][ "riotshield_crouch" ][ 2 ] = 0;
	initAnimSet["cover_trans_angles"][ "riotshield_crouch" ][ 3 ] = -45;
	initAnimSet["cover_trans_angles"][ "riotshield_crouch" ][ 4 ] = 90;
	initAnimSet["cover_trans_angles"][ "riotshield_crouch" ][ 6 ] = -90;
	initAnimSet["cover_trans_angles"][ "riotshield_crouch" ][ 8 ] = 180;

	initAnimSet["cover_trans_angles"][ "riotshield" ][ 1 ] = 45;
	initAnimSet["cover_trans_angles"][ "riotshield" ][ 2 ] = 0;
	initAnimSet["cover_trans_angles"][ "riotshield" ][ 3 ] = -45;
	initAnimSet["cover_trans_angles"][ "riotshield" ][ 4 ] = 90;
	initAnimSet["cover_trans_angles"][ "riotshield" ][ 6 ] = -90;
	initAnimSet["cover_trans_angles"][ "riotshield" ][ 8 ] = 180;

	animscripts\animset::RegisterArchetype( "riotshield", initAnimSet, false );
