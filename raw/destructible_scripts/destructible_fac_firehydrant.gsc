...
main()
{
	...
	// fire hydrant toy
	//---------------------------------------------------------------------
	destructible_create( "destructible_fac_firehydrant", "tag_origin", 250, undefined, 32, "no_melee" );
		destructible_splash_damage_scaler( 11 );
			...
			destructible_state( undefined, undefined, 800, undefined, 5, "no_melee" );
				...
				destructible_fx( "tag_fx", "vfx/ambient/water/fire_hydrant_spray_10_runner", false );
