...
//		level._pipes._effect[ "oil_leak_end" ]	 = LoadFX( "fx/impacts/pipe_oil_barrel_spill_ending1" );
		level._pipes._sound[ "oil_leak_hit" ] 	 = "mtl_steam_pipe_hit";
		level._pipes._sound[ "oil_leak_loop" ] 	 = "mtl_steam_pipe_hiss_loop";
		level._pipes._sound[ "oil_leak_end" ] 	 = "mtl_steam_pipe_hiss_loop_end";
