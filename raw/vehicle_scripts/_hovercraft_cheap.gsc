...
main( model, type, classname )
{
	...
	build_deathfx( "fx/_requests/hovercraft/vehicle_explosion_hovercraft", "tag_deathfx", undefined, undefined, undefined, undefined, 0 );
	
	build_bulletshield( true );
	build_life( 999, 500, 1500 );
	build_team( "allies" );
	
	level._effect[ "hovercraft_cheap_water" ]  = loadfx( "fx/treadfx/hovercraft_cheap" );
