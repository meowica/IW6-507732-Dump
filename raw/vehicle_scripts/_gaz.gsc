...
//	build_drive( %uaz_driving_idle_forward, %uaz_driving_idle_backward, 10 );
	...
	if ( IsSubStr( classname, "turret" ) )
	{
		...
		if ( IsSubStr( classname, "_factory" ) )
		{
			build_turret( "dshk_gaz_factory", "tag_turret", "weapon_dshk_turret", undefined, "auto_ai", 0.2, -20, -14 );
		}
		else
		{
...
build_gaz_death( classname )
{
	...
	build_deathfx( "fx/explosions/vehicle_explosion_gaz", "tag_deathfx" );
		
			   //   effect 						     tag 		     sound 	    bEffectLooping    delay      bSoundlooping    waitDelay   
	build_deathfx( "fx/fire/firelp_med_pm_nolight", "tag_cab_fx"  , undefined, undefined	   , undefined, true		   , 0 );
	build_deathfx( "fx/fire/firelp_small_pm_a"	  , "tag_trunk_fx", undefined, undefined	   , undefined, true		   , 3 );
	
	build_deathquake( 1, 1.6, 500 );

	//"Name: build_radiusdamage( <offset> , <range> , <maxdamage> , <mindamage> , <bKillplayer>, <delay> )"
	
	if ( classname != "script_vehicle_gaz_tigr_turret_physics_factory" )
	{
...
/*QUAKED script_vehicle_gaz_tigr_turret_factory (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER

This is identical to script_vehicle_gaz_tigr_turret except it allows bullet damage.

This will be added to your precache script when compile with Repackage Zone/Script:

vehicle_scripts\_gaz::main( "vehicle_gaz_tigr_b_iw6", "gaz_tigr_turret_factory", "script_vehicle_gaz_tigr_turret_factory" );

These will be added to your levels CSV when compile with Repackage Zone/Script:

include,vehicle_gaz_tigr_turret_factory
sound,vehicle_gaz_tigr_harbor,vehicle_standard,all_sp

defaultmdl="vehicle_gaz_tigr_b_iw6"
default:"vehicletype" "gaz_tigr_turret_factory"
default:"script_team" "axis"
*/

/*QUAKED script_vehicle_gaz_tigr_turret_physics_factory (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
include,vehicle_gaz_tigr_turret_physics_factory
sound,vehicle_gaz_tigr_harbor,vehicle_standard,all_sp

defaultmdl="vehicle_gaz_tigr_b_iw6"
default:"vehicletype" "gaz_tigr_turret_physics_factory"
default:"script_team" "axis"
*/

/*QUAKED script_vehicle_gaz_tigr_turret_physics_sand (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER

This will be added to your precache script when compile with Repackage Zone/Script:

vehicle_scripts\_gaz::main( "vehicle_gaz_tigr_b_iw6", "gaz_tigr_turret_physics_sand", "script_vehicle_gaz_tigr_turret_physics_sand" );
...
defaultmdl="vehicle_gaz_tigr_b_iw6"
default:"vehicletype" "gaz_tigr_turret_physics_sand"
default:"script_team" "axis"
*/
