...
#include vehicle_scripts\_littlebird_landing;
...
/*QUAKED script_vehicle_littlebird_md500 (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
defaultmdl="vehicle_md_500_little_bird"
default:"vehicletype" "littlebird"
default:"script_team" "axis"
*/

/*QUAKED script_vehicle_littlebird_armed_so (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
defaultmdl="vehicle_little_bird_armed"
default:"vehicletype" "littlebird_so"
*/
...
/*QUAKED script_vehicle_littlebird_spotlight (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
vehicle_scripts\_littlebird::main( "vehicle_little_bird_bench", "littlebird_spotlight", "script_vehicle_littlebird_spotlight" );
...
defaultmdl="vehicle_little_bird_bench"
default:"vehicletype" "littlebird_spotlight"
default:"script_team" "axis"
*/
...
main( model, type, classname )
{
	...
	build_template( "littlebird", model, type, classname );
	...
	build_deathfx( "fx/explosions/helicopter_explosion_secondary_small", "tag_engine", "littlebird_helicopter_secondary_exp", undefined	   , undefined, undefined	   , 0.0		, true );
	build_deathfx( "fx/fire/fire_smoke_trail_L"						, "tag_engine", "littlebird_helicopter_dying_loop"	 , true			   , 0.05	  , true		   , 0.5		, true );
	build_deathfx( "fx/explosions/helicopter_explosion_secondary_small", "tag_engine", undefined							 , undefined	   , undefined, undefined	   , 2.5		, true );
	build_deathfx( "fx/explosions/helicopter_explosion_little_bird", 		undefined, 		"littlebird_helicopter_crash", 			undefined, 	undefined,	undefined, 	- 1, 			undefined, 	"stop_crash_loop_sound" );
	
	//Death by Rocket effects, explodes immediatly
	build_rocket_deathfx( "fx/explosions/helicopter_explosion_little_bird_dcburn", 	"tag_deathfx", 	"littlebird_helicopter_crash", undefined, 			undefined, 		undefined, 		 undefined, true, 	undefined, 0 );
