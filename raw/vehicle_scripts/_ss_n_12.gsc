...
//	level._effect[ "afterburner" ]				= loadfx( "fx/fire/jet_afterburner_ignite" );
	level._effect[ "contrail"	] = LoadFX( "fx/smoke/smoke_geotrail_ssnMissile_trail" );
	level._effect[ "contrail12" ] = LoadFX( "fx/smoke/smoke_geotrail_ssnMissile12_trail" );
	////////////////////////
...
plane_sound_node()
{
	...
	while ( playerisinfront( other ) )
		wait 0.05;
	wait 0.5;// little delay for the boom
