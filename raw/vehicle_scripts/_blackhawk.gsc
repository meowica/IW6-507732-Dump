...
main( model, type, classname )
{
	...
	blackhawk_death_fx										 = [];
	blackhawk_death_fx[ "vehicle_blackhawk"				   ] = "fx/explosions/helicopter_explosion";
	blackhawk_death_fx[ "vehicle_blackhawk_sas_night"	   ] = "fx/explosions/helicopter_explosion";
	blackhawk_death_fx[ "vehicle_blackhawk_hero_sas_night" ] = "fx/explosions/helicopter_explosion";
	blackhawk_death_fx[ "vehicle_blackhawk_hero"		   ] = "fx/explosions/helicopter_explosion";
	blackhawk_death_fx[ "vehicle_blackhawk_low"			   ] = "fx/explosions/large_vehicle_explosion";
	blackhawk_death_fx[ "vehicle_blackhawk_low_thermal"	   ] = "fx/explosions/large_vehicle_explosion";
	deathmodelfx											 = blackhawk_death_fx[ model ];
	...
	build_rocket_deathfx( "fx/explosions/aerial_explosion_heli_large", 	"tag_deathfx", 	"blackhawk_helicopter_crash", undefined, 			undefined, 		undefined, 		 undefined, true, 	undefined, 0 );
			   ...
			   //   classname    type 	    fx 							   
	build_treadfx( classname  , "default", "fx/treadfx/heli_dust_default" );
	build_treadfx( classname  , "water"	 , "fx/treadfx/heli_water" );
	build_treadfx( classname  , "snow"	 , "fx/treadfx/heli_snow_default" );
	build_treadfx( classname  , "slush"	 , "fx/treadfx/heli_snow_default" );
	build_treadfx( classname  , "ice"	 , "fx/treadfx/heli_snow_default" );
	...
	build_light( classname, "cockpit_blue_cockpit01", "tag_light_cockpit01", "fx/misc/aircraft_light_cockpit_blue" , "interior", 0.0 );
	build_light( classname, "white_blink"			, "tag_light_belly"	   , "fx/misc/aircraft_light_white_blink"	, "running" , randomStartDelay );
	build_light( classname, "white_blink_tail"		, "tag_light_tail"	   , "fx/misc/aircraft_light_white_blink"	, "running" , randomStartDelay );
...
/*QUAKED script_vehicle_blackhawk_so (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
defaultmdl="vehicle_blackhawk"
default:"vehicletype" "blackhawk_so"
default:"script_team" "allies"
*/
...
/*QUAKED script_vehicle_blackhawk_low_so (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER

This will be added to your precache script when compile with Repackage Zone/Script:

vehicle_scripts\_blackhawk::main( "vehicle_blackhawk_low", "blackhawk_so", "script_vehicle_blackhawk_low_so" );
...
vehicle_scripts\_blackhawk::main( "vehicle_blackhawk_low_thermal", undefined, "script_vehicle_blackhawk_low_thermal" );
...
vehicle_scripts\_blackhawk_minigun::main( "vehicle_blackhawk_minigun_low", undefined, "script_vehicle_blackhawk_minigun_low" );

These will be added to your levels CSV when compile with Repackage Zone/Script:

include,vehicle_blackhawk_minigun
...
/*QUAKED script_vehicle_blackhawk_minigun_hero (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
defaultmdl="vehicle_blackhawk_minigun_hero"
default:"vehicletype" "blackhawk_minigun"
default:"script_team" "allies"
*/

/*QUAKED script_vehicle_blackhawk_minigun_player_so_ac130 (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER

This will be added to your precache script when compile with Repackage Zone/Script:

vehicle_scripts\_blackhawk_minigun::main( "vehicle_ny_blackhawk", "blackhawk_minigun_so_ac130", "script_vehicle_blackhawk_minigun_player_so_ac130" );

These will be added to your levels CSV when compile with Repackage Zone/Script:

include,vehicle_ny_blackhawk


defaultmdl="vehicle_ny_blackhawk"
default:"vehicletype" "blackhawk_minigun_so_ac130"
default:"script_team" "allies"
*/

/*QUAKED script_vehicle_ny_blackhawk (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
defaultmdl="vehicle_ny_blackhawk"
default:"vehicletype" "ny_harbor_blackhawk"
default:"script_team" "allies"
*/