...
main( model, type, classname )
{
	...
	zpu_death_fx = [];
	zpu_death_fx[ "vehicle_zpu4" ] = "fx/explosions/vehicle_explosion_bmp";
	zpu_death_fx[ "vehicle_zpu4_low" ] = "fx/explosions/vehicle_explosion_bmp";
...
vehicle_scripts\_zpu_antiair::main( "vehicle_zpu4", undefined, "script_vehicle_zpu4" );
...
vehicle_scripts\_zpu_antiair::main( "vehicle_zpu4_low", undefined, "script_vehicle_zpu4_low" );
