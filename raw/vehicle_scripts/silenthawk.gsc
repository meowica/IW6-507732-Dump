...
#include vehicle_scripts\silenthawk_landing;
#using_animtree( "vehicles" );


main( model, type, classname )
{
	build_template( "silenthawk", model, type, classname );
	build_localinit( ::init_local );

	build_deathmodel( "vehicle_silenthawk" );

	// Chopper that the player flies in on has door open
	if( classname == "script_vehicle_silenthawk_flood_player" )
	{
		build_drive( %silenthawk_doors_open, undefined, 0 );
	}
	else
	{
	...
	silenthawk_death_fx										   = [];
	silenthawk_death_fx[ "vehicle_silenthawk"				 ] = "fx/explosions/helicopter_explosion";
	deathmodelfx											   = silenthawk_death_fx[ model ];
...
//	build_attach_models( ::set_attached_models );
	...
	// Chopper that the player flys in on uses special anims for seat positions 2 and 3
	if( classname == "script_vehicle_silenthawk_flood_player" )
	{
		build_aianims( ::setanims_flood_infil, ::set_vehicle_anims );
	}
	else
	{
...
init_local()
{
	...
	self thread silenthawk_landing();
}
...
//	positions[ 6 ].idleoccurrence[ 1 ] = 246;
	...
	// FIX JKU need to make sense of this!
...
/*QUAKED script_vehicle_silenthawk (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
include,vehicle_silenthawk
sound,vehicle_blackhawk,vehicle_standard,all_sp


defaultmdl="vehicle_silenthawk"
default:"vehicletype" "silenthawk"
default:"script_team" "allies"
*/

/*QUAKED script_vehicle_silenthawk_flood_player (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
