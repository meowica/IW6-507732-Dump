...
{
	build_template( "snowmobile", model, type, classname );
	...
	build_light( classname, "taillight_truck_right" , "TAG_TAIL_LIGHT_LEFT", 	"fx/misc/car_taillight_jeep_r_clk"	 	, "headlights" );
	build_light( classname, "taillight_truck_left"	, "TAG_TAIL_LIGHT_LEFT", 	"fx/misc/car_taillight_jeep_l_clk"	 	, "headlights" );
	build_light( classname, "brakelight_truck_right", "TAG_TAIL_LIGHT_LEFT", 	"fx/misc/car_brakelight_truck_R_pb"	 	, "brakelights" );
	build_light( classname, "brakelight_truck_left" , "TAG_TAIL_LIGHT_LEFT", 	"fx/misc/car_brakelight_truck_L_pb"	 	, "brakelights" );
...
setanims()
{
	...
	positions[ 0 ].linktoblend = true;
	positions[ 0 ].rider_func = ::init_rider;
	positions[ 1 ].sittag = "tag_passenger";
	positions[ 1 ].linktoblend = true;
	positions[ 1 ].rider_func = ::init_rider;
...
vehicle_scripts\_snowmobile::main( "vehicle_snowmobile_alt", undefined, "script_vehicle_snowmobile_alt" );
...
vehicle_scripts\_snowmobile::main( "vehicle_snowmobile", "snowmobile_player_coop", "script_vehicle_snowmobile_coop" );
...
vehicle_scripts\_snowmobile::main( "vehicle_snowmobile_alt", "snowmobile_player_coop", "script_vehicle_snowmobile_coop_alt" );
