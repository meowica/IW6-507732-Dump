...
main( model, type, classname )
{
	...
	build_deathfx( "fx/explosions/large_vehicle_explosion", 	undefined, 				"car_explode_utility_truck", 						undefined, 			undefined, 		undefined, 		0 );
	...
	build_light( classname, "headlight_truck_left"	 , "tag_headlight_left"	 , "fx/misc/uk_utility_truck_headlight", "headlights" );
	build_light( classname, "headlight_truck_right"	 , "tag_headlight_right" , "fx/misc/uk_utility_truck_headlight", "headlights" );
	build_light( classname, "taillight_truck_right"	 , "TAG_TAIL_LIGHT_RIGHT", "fx/misc/car_taillight_bm21"		, "headlights" );
	build_light( classname, "taillight_truck_left"	 , "TAG_TAIL_LIGHT_LEFT" , "fx/misc/car_taillight_bm21"		, "headlights" );
	build_light( classname, "brakelight_troops_right", "TAG_TAIL_LIGHT_RIGHT", "fx/misc/car_taillight_bm21"		, "brakelights" );
	build_light( classname, "brakelight_troops_left" , "TAG_TAIL_LIGHT_LEFT" , "fx/misc/car_taillight_bm21"		, "brakelights" );
    
	anim_func = ::setanims;			
	build_aianims( anim_func, ::set_vehicle_anims );
	
				 //   classname 									    parts_array    
