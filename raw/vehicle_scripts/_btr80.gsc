...
main( model, type, classname )
{
	...
	btr80_death_fx = [];
	btr80_death_fx[ "vehicle_btr80" ] = "fx/explosions/vehicle_explosion_btr80";
	btr80_death_fx[ "vehicle_btr80_snow" ] = "fx/explosions/vehicle_explosion_btr80_snow";
	btr80_death_fx[ "vehicle_btr80_low" ] = "fx/explosions/vehicle_explosion_btr80";
	
	build_deathfx( "fx/fire/firelp_med_pm", "TAG_CARGOFIRE", "fire_metal_medium", undefined, undefined, true, 0 );
	build_deathfx( btr80_death_fx[ model ], "tag_deathfx", "exp_armor_vehicle" );

			 //   model       name 			      tag 					   effect 					    group 			    delay   
	build_light( classname, "headlight_L"	   , "TAG_FRONT_LIGHT_LEFT" , "fx/misc/car_headlight_btr80" , "running"		 , 0.0 );
	build_light( classname, "taillight_L"	   , "TAG_REAR_LIGHT_LEFT"	, "fx/misc/car_taillight_btr80" , "running"		 , 0.1 );
	build_light( classname, "taillight_R"	   , "TAG_REAR_LIGHT_RIGHT" , "fx/misc/car_taillight_btr80" , "running"		 , 0.1 );
	build_light( classname, "brakeight_R"	   , "TAG_REAR_LIGHT_RIGHT" , "fx/misc/car_brakelight_btr80", "brake"			 , 0.0 );
	build_light( classname, "brakelight_L"	   , "TAG_REAR_LIGHT_LEFT"	, "fx/misc/car_brakelight_btr80", "brake"			 , 0.0 );
	build_light( classname, "spotlight"	   , "TAG_FRONT_LIGHT_RIGHT", "fx/misc/spotlight_btr80"	 , "spotlight"		 , 0.2 );
	build_light( classname, "spotlight_turret", "TAG_TURRET_LIGHT"		, "fx/misc/spotlight_btr80"	 , "spotlight_turret", 0.0 );
...
in script: vehicle vehicle_lights_on( "spotlight" );
in script: vehicle vehicle_lights_on( "spotlight" );
...
on vehicle node: "script_vehicle_lights_off" "spotlight"
in script: vehicle vehicle_lights_on( "spotlight" );
in script: vehicle vehicle_lights_off( "spotlight" );
