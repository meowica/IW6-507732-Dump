...
main( model, type, classname )
{
	...
	hummer_death_fx = [];
	hummer_death_fx[ "vehicle_hummer" ] = "fx/explosions/vehicle_explosion_hummer";
	hummer_death_fx[ "vehicle_hummer_no_doors" ] = "fx/explosions/vehicle_explosion_hummer_nodoors";
	hummer_death_fx[ "vehicle_hummer_viewmodel" ] = "fx/explosions/vehicle_explosion_hummer_nodoors";
	hummer_death_fx[ "vehicle_hummer_opentop" ] = "fx/explosions/vehicle_explosion_hummer_nodoors";
	hummer_death_fx[ "vehicle_humvee_camo" ] = "fx/explosions/vehicle_explosion_medium";
	hummer_death_fx[ "vehicle_humvee_camo_50cal_doors" ] = "fx/explosions/vehicle_explosion_medium";
	hummer_death_fx[ "vehicle_humvee_camo_50cal_nodoors" ] = "fx/explosions/vehicle_explosion_medium";
...
vehicle_scripts\_humvee::main( "vehicle_hummer_no_doors",  undefined, "script_vehicle_hummer_nodoors" );
...
vehicle_scripts\_humvee::main( "vehicle_hummer_viewmodel",undefined, "script_vehicle_hummer_viewmodel" );
...
vehicle_scripts\_humvee::main( "vehicle_hummer_viewmodel", "hummer_physics", "script_vehicle_hummer_viewmodel_physics" );
...
vehicle_scripts\_humvee::main( "vehicle_hummer", "hummer_physics", "script_vehicle_hummer_physics" );
