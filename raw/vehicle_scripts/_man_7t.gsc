...
{
	//SNDFILE=vehicle_tatr_t815_troops
	build_template( "man_7t", model, type, classname );
//	build_template( "tatr_t815_troops", model, type, classname );
	build_localinit( ::init_local );
		
				  //   model 							     deathmodel 					   
//	build_deathmodel( "vehicle_bm21_mobile_cover_snow"	  , "vehicle_bm21_mobile_cover_dstry" );
	build_deathmodel( "vehicle_man_7t_iw6"				  , "vehicle_man_7t_destroy_iw6" );
...
//build_deathfx( "fx/explosions/large_vehicle_explosion", undefined, "explo_metal_rand" );
	...
	build_deathfx( "fx/explosions/large_vehicle_explosion", 	undefined, 				"car_explode", 						undefined, 			undefined, 		undefined, 		0 );
//	build_deathfx( "fx/fire/firelp_med_pm", 					"tag_fx_tire_right_r", 	undefined, 							undefined, 			undefined, 		true, 			0 );
//	build_deathfx( "fx/fire/firelp_med_pm", 					"tag_fx_cab", 			"fire_metal_medium", 				undefined, 			undefined, 		true, 			0 );
//	build_deathfx( "fx/explosions/small_vehicle_explosion", 	"tag_fx_tank", 			"explo_metal_rand", 				undefined, 			undefined, 		undefined, 		2 );
	...
	anim_func = ::setanims;	
	veh_anim_func = ::set_vehicle_anims;		
	build_aianims( anim_func, veh_anim_func );
	build_unload_groups( ::Unload_Groups );

			 //   model      name 						   tag 						   effect 					     group 		   
	build_light( classname, "headlight_truck_left"		, "tag_headlight_left"		, "fx/misc/lighthaze"			  , "headlights" );
	build_light( classname, "headlight_truck_right"		, "tag_headlight_right"		, "fx/misc/lighthaze"			  , "headlights" );
//	build_light( classname, "headlight_truck_left2"		, "tag_headlight_left"		, "fx/misc/car_headlight_bm21"	  , "headlights" );
//	build_light( classname, "headlight_truck_right2"	, "tag_headlight_right"		, "fx/misc/car_headlight_bm21"	  , "headlights" );
//	build_light( classname, "parkinglight_truck_left_f" , "tag_parkinglight_left_f" , "fx/misc/car_parkinglight_bm21", "headlights" );
//	build_light( classname, "parkinglight_truck_right_f", "tag_parkinglight_right_f", "fx/misc/car_parkinglight_bm21", "headlights" );
//	build_light( classname, "taillight_truck_right"		, "tag_taillight_right"		, "fx/misc/car_taillight_bm21"	  , "headlights" );
//	build_light( classname, "taillight_truck_left"		, "tag_taillight_left"		, "fx/misc/car_taillight_bm21"	  , "headlights" );
//	build_light( classname, "brakelight_troops_right"	, "tag_taillight_right"		, "fx/misc/car_taillight_bm21"	  , "brakelights" );
//	build_light( classname, "brakelight_troops_left"	, "tag_taillight_left"		, "fx/misc/car_taillight_bm21"	  , "brakelights" );

//	build_drive( %man_7t_idle_driving_idle_forward, %man_7t_idle_driving_idle_forward, 10 );
...
unload_groups()
{
	...
	//vehicle_scripts\_bm21_troops::main( "vehicle_bm21_mobile", undefined, "script_vehicle_bm21_mobile_troops" );
	//sound,vehicle_bm21,vehicle_standard,all_sp
	//sound,vehicle_tatr_t815_troops,vehicle_standard,all_sp
	// the names of the coll maps need to be the same as the model.
}

/*QUAKED script_vehicle_man_7t (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
include,vehicle_man_7t

defaultmdl="vehicle_man_7t_iw6"
default:"vehicletype" "man_7t"
default:"script_team" "axis"
*/

/*QUAKED script_vehicle_man_7t_k9 (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
defaultmdl="vehicle_man_7t_k9_iw6"
default:"vehicletype" "man_7t"
default:"script_team" "allies"
*/

/*QUAKED script_vehicle_man_7t_k9_physics (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
defaultmdl="vehicle_man_7t_k9_iw6"
default:"vehicletype" "man_7t_physics"
default:"script_team" "allies"
*/
