...
main( model, type, classname )
{
	...
	build_deathmodel( "vehicle_v22_osprey_heli" );
	build_deathmodel( "vehicle_v22_osprey_tailgunner" );
	...
	build_rocket_deathfx( "fx/explosions/aerial_explosion_apache_mp", 	"tag_deathfx", 	"apache_helicopter_crash",	undefined, 			undefined, 		undefined, 		 undefined, true, 	undefined, 0, 5 );

	if ( classname == "script_vehicle_osprey_tailgunner" )
	{
		build_turret( "osprey_tailgunner_turret", "tag_player_turret", "weapon_chinese_brave_warrior_turret", undefined, "manual", undefined, 0, 0, ( 128, 0, 16 ) );
	}
	...
	build_light( classname, "white_blink"			, "tag_light_belly"	   , "fx/misc/aircraft_light_red_blink"   , "running" , randomStartDelay );
	...
	if( classname == "script_vehicle_osprey_heli" )
		build_is_helicopter();
	else
		build_is_airplane();
...
land_structs_think( landing )
{
	...
	while ( true )
	{
		...
		if ( ! landing )
		{
			...
			osprey maps\_vehicle::aircraft_wash();
	}
}
...
/*QUAKED script_vehicle_osprey_heli (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
defaultmdl="vehicle_v22_osprey_fly"
default:"vehicletype" "osprey_heli"
default:"script_team" "allies"
*/

/*QUAKED script_vehicle_osprey_tailgunner (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER

This will be added to your precache script when compile with Repackage Zone/Script:

vehicle_scripts\_osprey::main( "vehicle_v22_osprey_fly",undefined, "script_vehicle_osprey_tailgunner" );
