...
main( model, type, classname )
{
	...
	if( classname == "script_vehicle_t90_tank_woodland_hamburg" )
	{
		...
		build_deathfx( "fx/explosions/vehicle_explosion_t90_cheap", 			"tag_deathfx", 			"exp_armor_vehicle", 		undefined, 			undefined, 		undefined, 		0, undefined, undefined, undefined, 8 );
	}
	else if ( classname == "script_vehicle_t90_tank_sand" )
	{
		build_deathmodel( "vehicle_t90_tank_woodland", "vehicle_t90_tank_woodland_d", 0.25 );
	...
	{
		build_deathmodel( "vehicle_t90_tank_woodland", "vehicle_t90_tank_woodland_dt", 0.25 );
				   //   effect 								   tag 		      sound 			   bEffectLooping    delay 	    bSoundlooping    waitDelay   
	...
	build_light( classname, "spotlight"	  , "TAG_LIGHT_TOP"		   , "fx/misc/spotlight_btr80"	  , "spotlight_turret", 0.0 );
	build_light( classname, "frontlight_L", "TAG_FRONT_LIGHT_LEFT" , "fx/misc/car_headlight_bm21", "running"		  , 0.1 );
	build_light( classname, "frontlight_R", "TAG_FRONT_LIGHT_RIGHT", "fx/misc/car_headlight_bm21", "running"		  , 0.1 );
	...
	else if( !IsSubStr( classname, "sand" ) )
		build_turret( "t90_turret2", "tag_turret2", "vehicle_t90_PKT_Coaxial_MG" );
	
	add_turret = IsSubStr( classname, "_turret" ) || IsSubStr( classname, "berlin" ) || IsSubStr( classname, "hamburg" ) || IsSubStr( classname, "sand" ) ;
...
/*QUAKED script_vehicle_t90_tank_sand (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER

This will be added to your precache script when compile with Repackage Zone/Script:

vehicle_scripts\_t90::main( "vehicle_t90_tank_woodland", "t90_sand", "script_vehicle_t90_tank_sand" );
