...
get_nag_event_type()
{
	...
	currentTime = self.laststand_info.bleedout_time;
	totalTime = self.laststand_info.bleedout_time_default;
	
	if ( currentTime < ( totalTime * level.laststand_stage2_multiplier ) )
	{
		type = "bleedout";
	}
