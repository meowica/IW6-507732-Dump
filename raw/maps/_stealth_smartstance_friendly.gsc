...
// Friendly AI must have maps\_stealth_utility::enable_stealth_smart_stance(); run on them to use this system!
// OR just set the ent_flag( "_stealth_stance_handler" ) on them
