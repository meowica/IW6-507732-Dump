...
dog()
{
	...
	level.scr_anim[ "generic" ][ "german_shepherd_attackidle_growl" ]		 = %iw6_dog_attackidle;
	level.scr_anim[ "generic" ][ "german_shepherd_attackidle_bark" ]		 = %iw6_dog_attackidle_bark;
	level.scr_anim[ "generic" ][ "german_shepherd_attackidle_once" ]		 = %iw6_dog_attackidle;
	level.scr_anim[ "generic" ][ "german_shepherd_attackidle" ][ 0 ]		 = %iw6_dog_attackidle;
	level.scr_anim[ "generic" ][ "german_shepherd_attackidle_b" ][ 0 ]		 = %iw6_dog_attackidle;
	level.scr_anim[ "generic" ][ "german_shepherd_run_start" ]		 = %iw6_dog_attackidle_runout_8;
