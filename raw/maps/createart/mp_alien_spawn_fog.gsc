...
main()
{
	ent = maps\_utility::create_vision_set_fog( "mp_alien_spawn" );
	...
	ent = maps\_utility::create_vision_set_fog( "mp_alien_spawn_red" );
	ent.startDist = 0;
	...
	ent = maps\_utility::create_vision_set_fog( "mp_alien_spawn_green" );
	ent.startDist = 0;
	...
	ent = maps\_utility::create_vision_set_fog( "mp_alien_spawn_blue" );
	ent.startDist = 15133;
	ent.halfwayDist = 5000;
	ent.red = 0.500007;
	ent.green = 0.500117;
