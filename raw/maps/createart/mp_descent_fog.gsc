...
main()
{
	ent = maps\_utility::create_vision_set_fog( "mp_descent" );
	...
	ent = maps\_utility::create_vision_set_fog( "mp_descent_red" );
	ent.startDist = 0;
	...
	ent = maps\_utility::create_vision_set_fog( "mp_descent_green" );
	ent.startDist = 0;
	...
	ent = maps\_utility::create_vision_set_fog( "mp_descent_blue" );
	ent.startDist = 15133;
	ent.halfwayDist = 5000;
	ent.red = 0.500007;
	ent.green = 0.500117;
