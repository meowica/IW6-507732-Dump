...
main()
{
	...
	ent.startDist = 70346.26;
	ent.halfwayDist = 100487.6;
	ent.red = 0.583682;
	ent.green = 0.52939;
	ent.blue = 0.302793;
	ent.maxOpacity = 1;
	...
	ent = maps\mp\_art::create_vision_set_fog( "mp_flooded_red" );
	ent.startDist = 0;
	...
	ent = maps\mp\_art::create_vision_set_fog( "mp_flooded_green" );
	ent.startDist = 0;
	...
	ent = maps\mp\_art::create_vision_set_fog( "mp_flooded_blue" );
	ent.startDist = 15133;
	ent.halfwayDist = 5000;
	ent.red = 0.500007;
	ent.green = 0.500117;
