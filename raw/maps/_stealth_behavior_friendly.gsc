...
friendly_state_spotted()
{
	...
	if ( self.type != "dog" || ( !isdefined( self.enemy ) || !isdefined( self.enemy.syncedMeleeTarget  ) ) ) // added so dog melee isn't interrupted
...
friendly_spotted_getup_from_prone( angles )
{
	...
	self thread stealth_anim_custom_animmode( self, "gravity", anime );
