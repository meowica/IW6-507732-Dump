...
create_default_entries()
{
	...
	archetype = "exposed_ready";
	item = "cover_trans_angles";
	anim.archetypes[ "soldier" ][item][ archetype ] = [];
	for( i=0; i< anim.archetypes[ "soldier" ][item][ "exposed" ].size; i++ )
		anim.archetypes[ "soldier" ][item][ archetype ][ i ] = anim.archetypes[ "soldier" ][item][ "exposed" ][ i ];

	item = "cover_trans_dist";		
	anim.archetypes[ "soldier" ][item][ archetype ] = [];
	for( i=0; i< anim.archetypes[ "soldier" ][item][ "exposed" ].size; i++ )
		anim.archetypes[ "soldier" ][item][ archetype ][ i ] = anim.archetypes[ "soldier" ][item][ "exposed" ][ i ];
	
	item = "cover_exit_angles";		
	anim.archetypes[ "soldier" ][item][ archetype ] = [];
	for( i=0; i< anim.archetypes[ "soldier" ][item][ "exposed" ].size; i++ )
		anim.archetypes[ "soldier" ][item][ archetype ][ i ] = anim.archetypes[ "soldier" ][item][ "exposed" ][ i ];
	
	item = "cover_exit_dist";		
	anim.archetypes[ "soldier" ][item][ archetype ] = [];
	for( i=0; i< anim.archetypes[ "soldier" ][item][ "exposed" ].size; i++ )
		anim.archetypes[ "soldier" ][item][ archetype ][ i ] = anim.archetypes[ "soldier" ][item][ "exposed" ][ i ];
	
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 1 ] = %run_trans_2_readystand_1;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 2 ] = %run_trans_2_readystand_2;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 3 ] = %run_trans_2_readystand_3;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 4 ] = %run_trans_2_readystand_4;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 6 ] = %run_trans_2_readystand_6;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 7 ] = %run_trans_2_readystand_7;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 8 ] = %run_trans_2_readystand_8;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 9 ] = %run_trans_2_readystand_9;

	anim.archetypes[ "soldier" ]["cover_exit"][archetype] = [];
	anim.archetypes[ "soldier" ]["cover_exit"][archetype][ 1 ] = %readystand_trans_2_cqb_1;
	anim.archetypes[ "soldier" ]["cover_exit"][archetype][ 2 ] = %readystand_trans_2_cqb_2;
	anim.archetypes[ "soldier" ]["cover_exit"][archetype][ 3 ] = %readystand_trans_2_cqb_3;
	anim.archetypes[ "soldier" ]["cover_exit"][archetype][ 4 ] = %readystand_trans_2_cqb_4;
	anim.archetypes[ "soldier" ]["cover_exit"][archetype][ 6 ] = %readystand_trans_2_cqb_6;
	anim.archetypes[ "soldier" ]["cover_exit"][archetype][ 7 ] = %readystand_trans_2_cqb_7;
	anim.archetypes[ "soldier" ]["cover_exit"][archetype][ 8 ] = %readystand_trans_2_cqb_8;
	anim.archetypes[ "soldier" ]["cover_exit"][archetype][ 9 ] = %readystand_trans_2_cqb_9;
	
	archetype = "exposed_ready_cqb";
	item = "cover_trans_angles";
	anim.archetypes[ "soldier" ][item][ archetype ] = [];
	for( i=0; i< anim.archetypes[ "soldier" ][item][ "exposed" ].size; i++ )
		anim.archetypes[ "soldier" ][item][ archetype ][ i ] = anim.archetypes[ "soldier" ][item][ "exposed" ][ i ];
	...
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 1 ] = %cqb_trans_2_readystand_1;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 2 ] = %cqb_trans_2_readystand_2;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 3 ] = %cqb_trans_2_readystand_3;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 4 ] = %cqb_trans_2_readystand_4;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 6 ] = %cqb_trans_2_readystand_6;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 7 ] = %cqb_trans_2_readystand_7;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 8 ] = %cqb_trans_2_readystand_8;
	anim.archetypes[ "soldier" ]["cover_trans"][archetype][ 9 ] = %cqb_trans_2_readystand_9;
