...
initHandSignals()
{
	...
	//level.scr_anim[ "generic" ][ "signal_go_cqb" ]			= %CQB_stand_wave_go_v1; //broken
	...
	level.scr_anim[ "generic" ][ "signal_moveup_coverL" ]	= %corner_standL_signal_move;		// TEMP
	level.scr_anim[ "generic" ][ "signal_stop_coverL" ]		= %corner_standL_signal_hold;
	level.scr_anim[ "generic" ][ "signal_onme_coverL" ]		= %corner_standL_signal_move;		// TEMP
	level.scr_anim[ "generic" ][ "signal_enemy_coverL" ]	= %corner_standL_signal_look;
	level.scr_anim[ "generic" ][ "signal_go_coverL" ]		= %corner_standL_signal_move;		// TEMP
}