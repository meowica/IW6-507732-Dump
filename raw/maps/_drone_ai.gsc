...
init()
{
	...
	level.drone_anims[ "allies" ][ "coverprone_no_pop" ][ "fire_exposed" ]	= %exposed_crouch_aim_5;  //special case for when prone guys occassionally stand up to fire
	level.drone_anims[ "allies" ][ "coverprone_no_pop" ][ "death" ]	 		= %saw_gunner_prone_death;
	//level.drone_anims[ "allies" ][ "coverprone_no_pop" ][ "arrival" ]	 	= %crouchrun2prone_straight;
	...
	level.drone_anims[ "axis" ][ "coverprone_no_pop" ][ "fire_exposed" ]	= %exposed_crouch_aim_5;  //special case for when prone guys occassionally stand up to fire
	level.drone_anims[ "axis" ][ "coverprone_no_pop" ][ "death" ]	 		= %saw_gunner_prone_death;
	//level.drone_anims[ "axis" ][ "coverprone_no_pop" ][ "arrival" ]	 	= %crouchrun2prone_straight;
	level.drone_anims[ "axis" ][ "coverprone_no_pop" ][ "pop_up_chance" ] = 0;		
	
	//team3 (?)
	//Using team 3 on dog/deer since civs use neutral. No iw6 levels appear to be using team3 drones. We can find a solution if need be. 
