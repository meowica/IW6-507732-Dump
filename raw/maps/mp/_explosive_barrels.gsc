main()
{
	...
	//------------------
		...
		if (qBarrels)
		{
			...
			level.breakables_fx["barrel"]["burn_start"]	= loadfx ("fx/props/barrel_ignite");
			level.breakables_fx["barrel"]["burn"]	 	= loadfx ("fx/props/barrel_fire_top");
		}
...
//		return;
	if ( !IsDefined( level.precachemodeltype[ "com_barrel_benzin" ] ) )
	{
		...
		HidePrecacheModelError( "com_barrel_piece" );
		HidePrecacheModelError( "com_barrel_piece2" );
	}
