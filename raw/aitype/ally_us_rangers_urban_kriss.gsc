...
/*QUAKED actor_ally_us_rangers_urban_KRISS (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	case 2:
		...
		break;
	case 3:
		character\character_us_rangers_smg_a_urban::main();
		break;
	}
}
...
precache()
{
	...
	character\character_us_rangers_smg_a_urban::precache();
