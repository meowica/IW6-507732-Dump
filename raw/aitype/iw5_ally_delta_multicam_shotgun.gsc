...
/*QUAKED actor_iw5_ally_delta_multicam_SHOTGUN (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
defaultmdl="body_delta_elite_shotgun_a"
...
main()
{
	...
	character\character_delta_elite_shotgun_a::main();
}
...
precache()
{
	character\character_delta_elite_shotgun_a::precache();
