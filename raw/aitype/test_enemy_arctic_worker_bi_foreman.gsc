...
/*QUAKED actor_test_enemy_arctic_worker_bi_foreman (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	character\character_chemwar_russian_assault_e_b::main();
}
...
precache()
{
	character\character_chemwar_russian_assault_e_b::precache();
