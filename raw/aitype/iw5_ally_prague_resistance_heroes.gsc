...
/*QUAKED actor_iw5_ally_prague_resistance_heroes (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	character\character_prague_males_heroes::main();
}
...
precache()
{
	character\character_prague_males_heroes::precache();
