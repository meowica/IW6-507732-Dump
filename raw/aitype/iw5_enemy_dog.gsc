...
/*QUAKED actor_iw5_enemy_dog (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
defaultmdl="german_shepherd_dog"
...
main()
{
	...
	character\character_sp_german_shepherd_dog::main();
}
...
precache()
{
	character\character_sp_german_shepherd_dog::precache();
