...
/*QUAKED actor_test_enemy_cornered_agent (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
defaultmdl="body_fso_vest_a"
...
main()
{
	...
	character\character_cnd_test_agent::main();
}
...
precache()
{
	character\character_cnd_test_agent::precache();
