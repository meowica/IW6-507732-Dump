...
/*QUAKED actor_hero_hesh_ranger_light (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
defaultmdl="fullbody_hesh_ranger_assault_a"
...
main()
{
	...
	character\character_hesh_ranger_assault_c::main();
}
...
precache()
{
	character\character_hesh_ranger_assault_c::precache();
