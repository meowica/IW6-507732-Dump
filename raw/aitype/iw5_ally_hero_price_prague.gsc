...
/*QUAKED actor_iw5_ally_hero_price_prague (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	character\character_hero_europe_price_cc::main();
}
...
precache()
{
	character\character_hero_europe_price_cc::precache();
