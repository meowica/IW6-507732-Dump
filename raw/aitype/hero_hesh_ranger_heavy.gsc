...
/*QUAKED actor_hero_hesh_ranger_heavy (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	character\character_hesh_ranger_assault_b::main();
}
...
precache()
{
	character\character_hesh_ranger_assault_b::precache();
